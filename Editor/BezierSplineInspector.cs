...
public class BezierSplineInspector : Editor {
    ...
    private const int stepsPerUnit = 1;
	...
	private void ShowDirections()
	{
        ...
        int steps = Mathf.RoundToInt(spline.SplineDistance)* stepsPerUnit;
		for (int i = 1; i <= steps; i++) {
			point = spline.GetPointUniform(i / (float)steps);
			Handles.DrawLine(point, point + spline.GetDirectionUniform(i / (float)steps) * directionScale);
		}
